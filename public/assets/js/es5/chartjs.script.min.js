...
$(document).ready(function () {
    var a = document.getElementById("LineChart").getContext("2d"), o = (new Chart(a, {
        type: "line",
        data: {
        ...
        options: {}
    }), a = document.getElementById("LineChart2"), new Chart(a, {
        type: "line",
        data: {
            labels: ["January", "February", "March", "April", "May", "June", "July"],
            datasets: [{
    ...
    }), a = document.getElementById("BarChart"), new Chart(a, {
        type: "bar",
        data: {
    ...
    }), a = document.getElementById("BarChart2"), new Chart(a, {
        type: "bar",
        data: {
            labels: ["January", "February", "March", "April", "May", "June", "July"],
            datasets: [{
            ...
            }, {label: "# of Votes", backgroundColor: "#36A2EB", data: [41, 56, 25, 48, 72, 34, 12]}]
        },
        options: {scales: {yAxes: [{ticks: {beginAtZero: !0}}]}}
    }), a = document.getElementById("MixChart"), new Chart(a, {
        type: "bar",
        data: {
        ...
        options: {scales: {yAxes: [{ticks: {beginAtZero: !0}}]}}
    }), a = document.getElementById("HorizontalBarChart"), new Chart(a, {
        type: "horizontalBar",
        data: {
            labels: ["January", "February", "March", "April", "May", "June", "July"],
            datasets: [{
        ...
        options: {scales: {yAxes: [{ticks: {beginAtZero: !0}}]}}
    }), a = document.getElementById("RadarChart"), {
    ...
    new Chart(a, {
        type: "radar",
        data: o
    }), a = document.getElementById("DoughnutChart"), o = {
        ...
        data: o
    }), a = document.getElementById("PieChart"), o = {
        labels: ["Mozila", "IE", "Google Chrome", " Edge", "Safari"],
        datasets: [{
            data: [120, 50, 140, 180, 100],
            backgroundColor: ["#455C73", "#9B59B6", "#BDC3C7", "#26B99A", "#3498DB"],
        ...
        tooltipFillColor: "rgba(51, 51, 51, 0.55)",
        data: o
    }), a = document.getElementById("PolarChart"), o = {
        labels: ["Mozila", "IE", "Google Chrome", " Edge", "Safari"],
        datasets: [{
            data: [120, 50, 140, 180, 100],
            backgroundColor: ["#455C73", "#9B59B6", "#BDC3C7", "#26B99A", "#3498DB"],
    ...
    }, new Chart(a, {type: "polarArea", tooltipFillColor: "rgba(51, 51, 51, 0.55)", data: o})
});
