...
class SuppressionTransactionNotification    extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        ->subject('Anullation de Transaction')
        ->markdown('emails.suppression-transaction', [
